...
<html lang="en">
  ...
  <body>
    ...
    <section
      ...
      style="background-image: url('img/haircare.png')"
    >
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-8 mx-auto mb-2">
          <div class="judul">
            <p>
              Haircare refers to the practice of maintaining and improving the
              health, strength, and appearance of hair through proper cleansing,
              conditioning, and nourishment. It involves using products such as
              shampoos, conditioners, hair masks, and oils to address specific
              hair concerns like dryness, frizz, dandruff, or damage caused by
              heat and styling. A good haircare routine helps to keep the scalp
              healthy, prevents breakage, and promotes smooth, shiny, and
              manageable hair. Choosing the right products based on hair type
              and needs is essential for maintaining overall hair health and
