...
<html lang="en">
  ...
  <body>
    ...
    <section
      ...
      style="background-image: url('img/makeup.png')"
    >
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-8 mx-auto mb-3">
          <div class="judul">
            <p>
              Makeup is the art of enhancing facial features using cosmetic
              products such as foundation, lipstick, eyeshadow, and blush. It
              serves various purposes, from creating a natural everyday look to
              achieving bold and artistic expressions. Makeup can help even out
              skin tone, highlight certain features, and boost confidence by
              allowing individuals to express their personal style.
              Additionally, it plays a significant role in fashion,
              entertainment, and professional settings. The key to good makeup
              application is choosing the right products for one's skin type and
              preferences while ensuring proper skincare to maintain healthy
              skin.
            </p>
          </div>
        </div>
